...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            Font negrita = new Font(Font.FontFamily.UNDEFINED, 12, Font.NORMAL, BaseColor.WHITE);
            fecha.add("\nFecha: "
            ...
            float[] columnWidths = new float[]{12f, 48f, 15f, 15f};
            ...
            separador.getDefaultCell().setBorder(0);
            float[] columnWidths3 = new float[]{100f};
            separador.setWidths(columnWidths3);
            ...
            float[] columnWidths2 = new float[]{70f, 30f};
            info.setWidths(columnWidths2);
            info.setHorizontalAlignment(Element.ALIGN_CENTER);
            info.addCell("");
            info.addCell("Total S/: " + total);
            doc.add(info);
